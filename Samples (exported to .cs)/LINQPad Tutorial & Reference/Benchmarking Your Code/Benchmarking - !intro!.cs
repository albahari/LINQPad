...
/* Exactly how long does it take to execute a try/catch block, a lock statement, or a SHA512 hash?
...
To demonstrate, highlight the following two lines of code and press Ctrl+Shift+B: */
...
ZERO-TOUCH
	...
	Select the code or method(s) you wish to benchmark and press Ctrl+Shift+B (Query | Benchmark Selected Code).
	No modifications to your script are required!
	
	For a complete demo, see query://Benchmarking_-_zero_touch_(statements)
	                     and query://Benchmarking_-_zero_touch_(program)
	
PROGRAMMATIC

	Go to the Query menu and choose "Add Programmatic Benchmark Support".
	...
	For a complete demo, see query://Benchmarking_-_programmatic
...
DIRECT
	...
	For a demo, see query://Benchmarking_-_direct
*/