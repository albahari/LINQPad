...
You can also create a code snippet from the button in the Script Properties dialog (F4).

LINQPad snippets are stored in <My Documents>/LINQPad Snippets by default, or ~/LINQPad/Snippets on macOS.
You can change this in Settings > Folders.
