...
void Main()
{
	// To execute a portion of a script, select the text and hit Run (F5).
	...
	// You can also highlight just an *expression*, even if the script is in Statements/Program mode.
