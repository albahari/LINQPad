...
void Main1() => "You ran Main1()".Dump();   // Press Alt+Shift+1 to run Main1()
void Main2() => "You ran Main2()".Dump();   // Press Alt+Shift+2 to run Main2()
void Main3() => "You ran Main3()".Dump();   // Press Alt+Shift+3 to run Main3()
// ... and so on to Main9
