...
To do this globally, go to Settings > Results and click the radio button for a custom style sheet.
...
You can do the same programmatically (for the current script) as follows: */
...
Util.Highlight ("highlight").Dump();    // see also script://../All_about_Dump/More_tricks/Highlighting_data
...
//                                  and script://../All_about_Dump/More_tricks/Advanced_Highlighting