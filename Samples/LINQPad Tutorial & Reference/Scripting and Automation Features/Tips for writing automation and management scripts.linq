...
/* Here are some tips for writing scripts for automation/management/deployment:
	...
	* For storing passwords, Util.GetPassword is your friend  - see query://../Runtime_services/Securely_storing_passwords
	  This lets you save passwords securely without exposing them as plain text in your scripts.
	  
	* You can prompt for data with Util.ReadLine - see query://../Runtime_services/Prompting_for_data_with_Util.ReadLine
	...
	* To re-use methods/classes between queries, use 'My Extensions'
	
	* To quickly open a script from the UI, use Ctrl+,
	  From there, Ctrl+Enter opens and runs the script in one step.
