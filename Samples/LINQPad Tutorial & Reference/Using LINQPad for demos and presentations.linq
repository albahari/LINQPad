 ...
 *	To order your scripts/folders in a logical sequence, don't waste time prefixing them
	with numbers! Instead, right-click the parent folder in My Scripts and choose 'Reorder Items'.
	
 *	You can easily load demo scripts into the 'Samples' folder. Right-click the folder in 'My Scripts'
 ...
 *	To adjust font size, use Control+MouseWheel or Ctrl+Shift+Minus / Ctrl+Shift+Plus (Command key on macOS)
	This works in both the editor and in the results panel.
