...
/* You can start LINQPad with the following arguments and switches:
   ...
   <script-to-open> [-run] [-hideeditor] [-newinstance]

Use -run to run a script immediately.
...
Switches for license activation:
	...
	To activate a license:
		LINQPadx -activate=<activation code>

	To activate a license for all users on the machine:
		LINQPadx -activateall=<activation code>

	To remove the license:
		LINQPadx -deactivate

To run scripts from the command-line without the LINQPad GUI,
