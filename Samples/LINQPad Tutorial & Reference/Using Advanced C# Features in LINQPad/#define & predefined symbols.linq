...
#if NETCORE                      // true if running .NET Core 3 or later (i.e., LINQPad 6/7/8/9+ rather than LINQPad 5)
	".NET Core".Dump();
#else
...
#if NET10
	"You're on .NET 10 or later".Dump();
#endif
...
#if MACOS
	"You have a fast and quiet machine".Dump();
#endif
