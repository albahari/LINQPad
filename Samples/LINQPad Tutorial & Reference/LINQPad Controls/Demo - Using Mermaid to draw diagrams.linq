...
var editor = new TextArea (definition) { Rows = 20, Cols = 60 }.WithStyle ("font-family", "monospace");
editor.TextInput += (s, e) => mermaid.Definition = editor.Text;

new WrapPanel (
	childVerticalAlign: "top",
	children: [
		new StackPanel (false, editor, new Button ("Save SVG", b => mermaid.SaveSvg())),
		mermaid
	]
).Dump();
