...
// In other words, you can execute new scripts without recomputing previous values.

var expensiveValue = Util.Cache (ExpensiveValue, "someKey");  // Never have to compute this again.
expensiveValue.Dump();

// After executing the script, change the following function to something else (or add another line below).
